...
def update_game(access_token):
    ...
    console.print("[italic yellow]Enter the field that you wish to update (i.e. Name, Genre, Platform[/italic yellow]")
    update_field = input().lower()

    console.print("[italic yellow]Enter the value you want to update with[/italic yellow]")
    update_value = input()
